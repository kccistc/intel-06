...
Original file is located at
    https://colab.research.google.com/drive/12NfzcAR0YmdnHTCVj_HxXdkkPZTDc0Qa
"""
...
def steepest_descent_twod(func,gradx,grady,x0,Maxlter=10,
...
for epoch in range(MaxEpochs):
  ...
  for x_batch,y_batch in generate_batches(batch_size,x_train,y_train):
    path_mm.append(w0)
    grad=loss_grad(w0,x_batch,y_batch)
    veloctiy=alpha*veloctiy-lr*grad
    w1=w0+veloctiy
    w0=w1
