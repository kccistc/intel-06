...
Original file is located at
    https://colab.research.google.com/drive/1uiejOPmzO3uqk6LqnFHPjQqc9Mrc2arg
"""
...
ax = pit.axes()
ax.contour(x, y, z, levels=np.linspace(0, 10, 20), cmap=pit.cm.jet)
...
pit.xlabel('x')
pit.ylabel('f(x)')
pit.title('plot of f(x)')

pit.plot(xopt, f(xopt),'xr')
...
def steepest_descent_twod(func, grad_x, grad_y, x0, Maxlter=10, learning_rate=0.25, verbose=True):
  paths = [x0]
