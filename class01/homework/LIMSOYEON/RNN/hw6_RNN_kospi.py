...
import matplotlib
matplotlib.use('TkAgg')  # 또는 'Qt5Agg' depending on your system
...
plt.plot(test_y, label='Actual Close Price')         # 실제 종가
plt.plot(pred_y, label='Predicted Close Price')      # 예측 종가
plt.xlabel('Days')
